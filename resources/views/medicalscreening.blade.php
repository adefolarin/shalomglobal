                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="common-banner-title">
                            <h3>Free Medical Screening</h3>
                            <a href="{{ url('/') }}">Home </a>/
                            <span> Free Medical Screening</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="causes-card">
                            <div class="causes-image-container cause-details-container">
                                ...
                                <div class="header-link-btn"><a href="#" class="btn-1">Medical Screening<span></span></a></div>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="causes-card" style="display:none;">
                            <div class="causes-content causes-details-content">
                                <h5>Medical Screening for all</h5>
                            </div>
                        ...
                        <div class="main-causes-content">
                            <p>As part of our initiatives, we prioritize the health and well-being of underserved communities by providing essential medical screening services. Our goal is to ensure that individuals in these communities have access to early detection and prevention measures, regardless of their socio-economic status.</p>

                            <p>By bringing medical screenings directly to underserved communities, we aim to remove barriers to access and empower individuals to take control of their health. Our screenings are conducted with compassion, respect, and sensitivity, recognizing the unique needs and challenges faced by those we serve.</p>
                            <div class="causes-details-title">
                                <h5>Our Approach</h5>
                            </div>
                            <p>Through our dedicated team of healthcare professionals and volunteers, we offer comprehensive medical screenings that encompass a range of health indicators. From basic vital signs checks to more specialized screenings for conditions such as diabetes, hypertension, and cancer, we strive to identify potential health risks and provide early intervention and education where needed.</p>
                        ...
                        <div class="main-causes-content">
                            <p>Through these efforts, we hope to contribute to improved health outcomes and ultimately reduce health disparities in underserved communities. Together, we can make a difference in the lives of individuals and families by promoting early detection, prevention, and wellness.
                            <p></p>
                        </div>
                    </div>   
                </div>
